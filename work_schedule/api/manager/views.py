...
from api.manager.schemes import CreateSchema, FullDataDriverSchema, AssignCarDriverSchema, AssignCarDriverCreateSchema
...
class ManagerViews(BaseView):
    ...
    async def create_assign_car_driver(self, data: AssignCarDriverCreateSchema) -> AssignCarDriverSchema:
