...
Revision ID: d061f29cdca2
Revises: 
Create Date: 2025-01-17 22:10:39.008731
...
def upgrade() -> None:
    ...
    op.create_index('type_index', 'schedule_types', ['name', 'work_days', 'weekend_days'], unique=False, schema='work_schedule')
    op.create_table('car_driver_association',
    sa.Column('car_id', sa.Integer(), nullable=True),
    sa.Column('driver_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['car_id'], ['work_schedule.car.id'], ),
    sa.ForeignKeyConstraint(['driver_id'], ['work_schedule.driver.id'], ),
    schema='work_schedule'
    )
    ...
    sa.Column('date', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=False),
