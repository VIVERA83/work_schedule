...
work_schedule_driver_4 = WorkerSchedule(
    "driver_4",
    datetime(year=2025, month=1, day=1),
    work_days=6,
    weekend_days=3,
...
work_schedule_driver_5 = WorkerSchedule(
    "driver_5",
    datetime(year=2025, month=1, day=1),
    work_days=6,
    weekend_days=3,
...
work_schedule_driver_6 = WorkerSchedule(
    "driver_6",
    datetime(year=2025, month=1, day=1),
    work_days=6,
    weekend_days=3,
...
work_schedule_car_3 = WorkerSchedule(
    "Car_3",
    datetime(year=2025, month=1, day=1),
    work_days=-1,
    weekend_days=-1,
...
work_schedule_car_4 = WorkerSchedule(
    "Car_4",
    datetime(year=2025, month=1, day=1),
    work_days=-1,
    weekend_days=-1,
...
if __name__ == "__main__":
    ...
    used, not_used = combined_employees_work_plan_1.add_combined_employees_work_plan(
        combined_employees_work_plan_2
    )
    ic(used)
    ic(not_used)
